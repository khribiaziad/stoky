...
def get_summary(
    ...
    return hassan_summary(db, s, e, get_store_id(user))
...
def top_products(
    ...
    query = (
        db.query(
            ...
            func.sum(models.OrderItem.quantity * func.coalesce(models.OrderItem.unit_price, models.OrderItem.unit_cost, 0)).label("revenue"),
        )
...
def top_cities(
    ...
    query = (
        ...
        .filter(
            ...
            models.Order.user_id == get_store_id(user),
            models.Order.is_deleted != True,
            models.Order.city.isnot(None),
            models.Order.city != "",
            models.Order.total_amount > 0,
        )
